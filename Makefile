...
$(ADT1_TESTS): $(ADT1_TESTS).o $(ADT1_OBJECT) $(ADT2_OBJECT)
	$(LINK) $(ADT1_TESTS) $(ADT1_TESTS).o $(ADT1_OBJECT) $(ADT2_OBJECT)
...
$(ADT1_TESTS).o: $(ADT1_TESTS).cpp $(ADT1_HEADER) $(ADT2_HEADER)
	$(COMPILE) $(ADT1_TESTS).cpp
